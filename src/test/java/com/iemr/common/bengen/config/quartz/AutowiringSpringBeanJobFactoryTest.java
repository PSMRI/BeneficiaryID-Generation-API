...
class AutowiringSpringBeanJobFactoryTest {
    ...
    private void stubBundle() {
        lenient().when(triggerFiredBundle.getJobDetail()).thenReturn(benGenJobDetail());
    ...
    private JobDetail benGenJobDetail() {
        JobDetailFactoryBean factory = new JobDetailFactoryBean();
        factory.setJobClass(ScheduleJobServiceForBenGen.class);
        factory.setName("bengen-job");
    ...
    void createJobInstance_shouldAutowireJobThroughApplicationContext() throws Exception {
        ...
        assertNotNull(job);
        assertTrue(job instanceof ScheduleJobServiceForBenGen);
