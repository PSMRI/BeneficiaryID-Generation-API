...
class GenericEmailServiceImplDiffblueTest {
    ...
    void testSendEmail() {
        ...
        //   test threw
        //   org.json.JSONException: Value Json of type java.lang.String cannot be converted to JSONObject
        //       at org.json.JSON.typeMismatch(JSON.java:111)
        //       at org.json.JSONObject.<init>(JSONObject.java:159)
        //       at org.json.JSONObject.<init>(JSONObject.java:172)
        //       at com.iemr.common.bengen.utils.gateway.email.GenericEmailServiceImpl.sendEmail(GenericEmailServiceImpl.java:60)
    ...
    void testSendEmail2() {
        ...
        //       at org.json.JSONObject.<init>(JSONObject.java:159)
        //       at org.json.JSONObject.<init>(JSONObject.java:172)
        //       at com.iemr.common.bengen.utils.gateway.email.GenericEmailServiceImpl.sendEmail(GenericEmailServiceImpl.java:40)
        //   See https://diff.blue/R013 to resolve this issue.
