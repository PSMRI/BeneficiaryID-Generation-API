...
class SessionObjectDiffblueTest {
    ...
    void testGetSessionObject() throws RedisSessionException {
        ...
        // Assert
        verify(redisStorage).getObject(eq("Key"), Mockito.<Boolean>any(), eq(7200));
    ...
    void testSetSessionObject() throws RedisSessionException {
        ...
        // Assert
        verify(redisStorage).setObject(eq("Key"), eq("42"), eq(7200));
    ...
    void testUpdateSessionObject() throws RedisSessionException {
        ...
        // Assert
        verify(redisStorage).updateObject(eq("Key"), eq("42"), Mockito.<Boolean>any(), eq(7200));
